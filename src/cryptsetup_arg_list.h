...
ARG(OPT_DISABLE_SUM, '\0', POPT_ARG_NONE, N_("Disable OPAL2 SUM (Single User Mode)"), NULL, CRYPT_ARG_BOOL, {}, OPT_DISABLE_SUM_ACTIONS)
...
ARG(OPT_KEYS_FROM_STDIN_SIZES, '\0', POPT_ARG_STRING, N_("Read keys from stdin with the given sizes (comma-separated list of integers)"), N_("SIZES"), CRYPT_ARG_STRING, {}, OPT_KEYS_FROM_STDIN_SIZES_ACTIONS)
