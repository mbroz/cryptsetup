...
*cryptsetup <options> _close_ <name>*
...
*plainClose*, *luksClose*, *loopaesClose*, *tcryptClose* (all behaves
exactly the same, device type is determined automatically from active
device).
