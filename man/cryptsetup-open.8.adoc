...
*cryptsetup <options> _open_ <device> <name> --type <device_type>* +
...
*WARNING:* The loop-AES extension cannot use the direct input of key
file on real terminal because the keys are separated by end-of-line and
