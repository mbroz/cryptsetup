...
Reencrypt LUKS2 device with 2 keyslots (with passphrases "pass1" and "pass2222"):

*echo "pass1pass2222" | cryptsetup reencrypt --keys-from-stdin-sizes 5,8 /dev/encrypted_device*
