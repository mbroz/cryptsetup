...
only relevant for the _open_ action with plain or loopaes device types and for
LUKS devices in _luksFormat_ and _reencrypt_.
+
...
_luksFormat_, _luksAddKey_ or _reencrypt_. The default is 3 tries.
endif::[]
...
ifdef::ACTION_OPEN,ACTION_STATUS,ACTOION_REENCRYPT,ACTION_RESIZE,ACTION_LUKSFORMAT,ACTION_LUKSSUSPEND,ACTION_LUKSRESUME,ACTION_LUKSADDKEY,ACTION_LUKSREMOVEKEY,ACTION_LUKSCHANGEKEY,ACTION_LUKSCONVERTKEY,ACTION_LUKSKILLSLOT,ACTION_LUKSDUMP,ACTION_TOKEN,ACTION_CONVERT,ACTION_CONFIG,ACTION_REENCRYPT[]
